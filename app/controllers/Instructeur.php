    ...
    public function overzichtInstructeur() 
{
    ...
    public function deleteInstructeur($instructeurId)
    {
        ...
        if ($delete) {
            echo "Het record is verwijderd";
            header('Refresh:2.5; url=http://www.php-mvc-periode1.com/instructeur/overzichtInstructeur/' . $instructeurId);
        } else {
            echo "Het record is niet verwijderd";
        }
    }
    ...
    public function present($id)
    {
        ...
        if ($update) {
            ...
            header('Refresh:2.5; url=http://www.php-mvc-periode1.com/instructeur/overzichtInstructeur/' . $id);
        } else {
